...
class ListReadActivities extends StatefulWidget {
  //

  static String label = 'Actividades de lectura 📚';
  const ListReadActivities({super.key});

  @override
  State<ListReadActivities> createState() => _ListReadActivitiesState();
}

class _ListReadActivitiesState extends State<ListReadActivities> {
  //
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) {
        ...
        getRecentActivitiesController.run(activityType: ActivityType.READING);
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          Titles.subtitle(ListReadActivities.label),
          Spacers.spacer10,
          ActivitiesCarouselHorizontal(
            activities: getActivitiesByKeyTypeState.getReadingActivities(),
          ),
        ],
      ),
    );
