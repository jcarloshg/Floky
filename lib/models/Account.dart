...
class Account extends Model {
  ...
  const Account._internal({required this.id, required fullName, required email, required collegeEnrollment, required collegeName, activitiesProgress, role, createdAt, updatedAt, accountActivitiesProgressId}): _fullName = fullName, _email = email, _collegeEnrollment = collegeEnrollment, _collegeName = collegeName, _activitiesProgress = activitiesProgress, _role = role, _createdAt = createdAt, _updatedAt = updatedAt, _accountActivitiesProgressId = accountActivitiesProgressId;
  
  factory Account({String? id, required String fullName, required String email, required String collegeEnrollment, required String collegeName, ActivitiesProgress? activitiesProgress, Role? role, String? accountActivitiesProgressId}) {
  ...
  Account copyWith({String? id, String? fullName, String? email, String? collegeEnrollment, String? collegeName, ActivitiesProgress? activitiesProgress, Role? role, String? accountActivitiesProgressId}) {
    return Account._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'fullName': _fullName, 'email': _email, 'collegeEnrollment': _collegeEnrollment, 'collegeName': _collegeName, 'activitiesProgress': _activitiesProgress?.toJson(), 'role': enumToString(_role), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'accountActivitiesProgressId': _accountActivitiesProgressId
  };
